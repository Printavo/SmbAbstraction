...
public class SmbFileSystemInformation
{
    ...
    /// <remarks>
    /// Ensure NTStatus.STATUS_SUCCESS on the <paramref name="fileStore"/> construction before calling this constructor.
    /// </remarks>
    public SmbFileSystemInformation(ISMBFileStore fileStore)
    {
